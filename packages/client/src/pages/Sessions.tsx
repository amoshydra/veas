              ...
              >
                ...
                >
                  {renamingId === s.id ? (
                    <input
                      ...
                      onKeyDown={(e) => {
                        if (e.key === "Enter") {
                          renameMutation.mutate({ id: s.id, name: renameValue.trim() });
                        }
                      ...
                      className="px-1 py-0.5 text-sm bg-slate-700 border border-blue-500 rounded text-white focus:outline-none w-full"
                      autoFocus
                    />
                  ) : (
                ...
                <div className="flex items-center gap-1 ml-2">
                  <button
                    ...
                    className="px-2 py-1 text-slate-400 hover:text-slate-300 text-sm"
                  >
                    Rename
                  </button>
                  <button
